<?php
/**
 * @package DOTK_BlockSpam
 * @version 1.0
 */
/*
Plugin Name: DOTK BlockSpam
Plugin URI: https://www.durkotheek.nl
Description: getting tired of all spam-comments, block the POST!
Author: ing. Dirk Hornstra
Version: 1.0
Author URI: https://www.durkotheek.nl/
*/

add_action( 'wp_loaded','my_post_validation' );

function my_post_validation() 
{
